const Task=[
   ...
   document.write("Your task: " + Task[i].TaskName+ "<br/>"+"Due Date:"
   
   + Task[i].dueDate + "<br/>"+"Priority: " +
   Task[i].priority+"<br/>"+"Completion Status:"+Task[i].completed+"<br/>");
   ...
   {
   document.write("Your task "+Task[i].TaskName+" is yet to be completed"
   +"<br/>");
   document.write("<br/>");
   }
   }
   ...
   for(let i=0;i<n;i++)
   {
   taskList.push({TaskName: prompt("Task name"), dueDate: prompt("Due date"),
   priority: prompt("Task priority"), completed: prompt("Task status")});
   alert('Task Added');
   }
